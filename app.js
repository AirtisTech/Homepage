...
const i18n = {
    zh: {
        ...
        services_title: "核心服务",
        services_subtitle: "我们提供全方位的数字化转型解决方案，助您的品牌在数字时代脱颖而出。",

        service_uiux_title: "UI/UX 体验设计",
        service_uiux_desc: "以用户为中心，雕琢每一个交互细节，提供极致、直观且具备高转化率的数字化界面设计。",
        service_dev_title: "定制软件开发",
        service_dev_desc: "从前端到后端、从移动应用到云原生架构，我们使用最新技术栈为您打造高性能、高可用的数字产品。",
        service_brand_title: "品牌创意策划",
        service_brand_desc: "深度挖掘品牌核心价值，提供包括品牌定位、视觉识别系统、营销创意及数字化品牌传播的全链路服务。",
        service_photo_title: "商业摄影 / 视频",
        service_photo_desc: "拥有专业级摄影与影视制作团队，提供产品拍摄、企业宣传片、航拍及后期制作一站式影像解决方案。",
    ...
    en: {
        ...
        services_subtitle: "We provide comprehensive digital transformation solutions to help your brand stand out in the digital age.",

        service_uiux_title: "UI/UX Experience Design",
        service_uiux_desc: "User-centered design crafting every interaction detail, delivering premium, intuitive interfaces with high conversion rates.",
        service_dev_title: "Custom Software Development",
        service_dev_desc: "From frontend to backend, mobile apps to cloud-native architecture — we build high-performance, scalable digital products with the latest tech stack.",
        service_brand_title: "Brand Strategy & Creative",
        service_brand_desc: "Deep-dive brand value discovery, offering brand positioning, visual identity systems, marketing creativity, and digital brand communication.",
        service_photo_title: "Commercial Photography / Video",
        service_photo_desc: "Professional photography and film production team offering product shoots, corporate videos, aerial filming, and post-production services.",
